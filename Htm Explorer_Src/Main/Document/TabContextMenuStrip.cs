...
{
    public class TabContextMenuStrip
    {
        public TabContextMenuStrip(TabControl tabControl, LabelButton lablBtn)                                     
        {
        ...
        private void labelButton1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Point pt = new Point(labelButton1.Location.X + 1 - contextMenuStrip1.Width + labelButton1.Width, labelButton1.Location.Y + labelButton1.Height - 1);
