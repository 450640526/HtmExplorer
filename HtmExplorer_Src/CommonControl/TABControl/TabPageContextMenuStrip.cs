...
namespace System
{
    ...
    /// 选中的节点 的右键菜单
    /// </summary>
    public class TabPageContextMenuStrip
    {
        public TabPageContextMenuStrip(TabControl tabControl)
        {

            tabControl1 = tabControl;
            tabControl1.MouseDown += new System.Windows.Forms.MouseEventHandler(tabControl1_MouseDown);
            tabControl1.KeyDown += new System.Windows.Forms.KeyEventHandler(this.tabControl1_KeyDown);
