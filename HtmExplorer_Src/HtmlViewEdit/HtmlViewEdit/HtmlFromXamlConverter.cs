...
namespace System
{
    ...
    public static class HtmlFromXamlConverter
    {
        ...
        /// Converts a xaml string into HTMLClass string.
        /// </summary>
        ...
        /// XmlTextWriter producing resulting HTMLClass
        /// </param>
        ...
        /// them into appropriate HTMLClass attributes or css styles.
        /// </summary>
        /// <param name="xamlReader">
        ...
        /// </param>
        /// <param name="htmlWriter">
        /// XmlTextWriter for output HTMLClass, which is expected to be in
        ...
        /// witout producing any output to HTMLClass.
        /// </param>
        /// <param name="inlineStyle">
        ...
        /// <summary>
        /// Converts a xaml element into an appropriate HTMLClass element.
        /// </summary>
        /// <param name="xamlReader">
        /// On entry this XmlTextReader must be on Element start tag;
        /// on exit - on EndElement tag.
        ...
        /// without producing any HTMLClass output
        /// </param>
        /// <param name="inlineStyle">
